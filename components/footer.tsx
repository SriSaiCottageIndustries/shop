...
export function Footer() {
  ...
  const footerLinks = {
    Shop: [
      ...
      { name: "Idols", href: "/products?category=Idols" },
      { name: "Pooja Essentials", href: "/products?category=Pooja%20Essentials" },
    ],
    Company: [
    ...
    Support: [
      ...
      { name: "Shipping Policy", href: "/contact#shipping" },
      { name: "Returns & Refunds", href: "/contact#returns" },
    ],
  }
      ...
      <div className="container-custom py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-12">
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">Sri Sai Cottage Industries</h3>
              <p className="text-neutral-600 mb-6 leading-relaxed">
                Authentic handcrafted pooja items, made with devotion and traditional expertise to bring divine blessings to your home.
              </p>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-neutral-500 text-center">
            <p>&copy; {currentYear} Sri Sai Cottage Industries. All rights reserved.</p>
